    ...
    return (
      ...
      <div className="App">
        ...
        <div className="skills">
          <h2 className="skills-title title-position">SKILLS</h2>
          <br/>
          <h3 className="set skill-about">React, Node.js/Express, Javascript (ES6), HTML5, CSS3, Postgresql, JQuery, Ruby On Rails, Git, Github, Heroku, Responsive Design...</h3>
        </div>

        <div id="projects">
          <h2 className="skills-title title-position">WORK</h2>
          <br/>
              <div class="project-info">
               <CarouselCA4LC />
                <h3 className="set title">CATCH A FOUR LEAF CLOVER</h3>
              ...
              <div class="project-info">
              <CarouselCrudye />
                <h3 className="set title">CRUDYE</h3>
              ...
              <div class="project-info">
                <h3 className="set title">FOODFAV</h3>
              ...
              <div class="project-info">
              <CarouselNudistguise />
                <h3 className="set title">NUDISTGUISE</h3>
